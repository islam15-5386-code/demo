...
export const seedState: MockLmsState = {
  branding: {
    ...
    tenantName: "Betopia Academy",
    vendorName: "Betopia Academy",
  ...
  liveClasses: [
    {
      ...
      provider: "Jitsi",
      meetingUrl: "https://meet.jit.si/Betopia-Compliance-Weekly-QA",
      recordingUrl: null,
      reminder24h: true,
      reminder1h: true,
      status: "scheduled"
    },
    {
      ...
      provider: "Jitsi",
      meetingUrl: "https://meet.jit.si/Betopia-AI-Teaching-Lab",
      recordingUrl: "https://meet.jit.si/Betopia-AI-Teaching-Lab",
      reminder24h: true,
      reminder1h: true,
      status: "recorded"
    }
